...
DWORD g_TlsIndex = 884;//tls添加


VOID WINAPI new_prot ( Filter_Condition task)
{
    DWORD lenth;
    DeviceIoControl(mydevice, NEW_FC_CODE, NULL, 0, &task, sizeof(Filter_Condition), &lenth, NULL);
    return;
}
